      ...
      minHeap.push(
        ...
        struct Star{
            ...
            vector<Star> largestK(int k, vector<Star>::const_iterator iter_begin, vector<Star>::const_iterator iter_end){
                ...
                int bsearch(const vector<int>&A, int t){
                    int i =0; int U =(int) A.size()-1;
                    while(i<=U){
                        int M= floor(i+(U-i)/2);
                        if(t>A[M]){
                            i=M+1;
                ...
                int bsearchFirstOccur(const vector<int>&A, int t){
                    int i =0; int U =(int) A.size()-1; int result =-1;
                    while(i<=U){
                        int M= floor(i+(U-i)/2);
                        if(t>A[M]){
                            i=M+1;
                    ...
                    struct Student{
                        ...
                        double gpa;
                         ...
                         function<bool(const Student&, const Student&)> compGPA =
                        [](const Student& studentA, const Student& studentB){
                            if(studentA.gpa !=studentB.gpa){
                                return studentA.gpa>studentB.gpa;
                                }
...
cout<<bsearchFirstOccur(A,285)<<endl;
  ...
  vector<Student> students{studenta,studentc,studentd,studentb};
